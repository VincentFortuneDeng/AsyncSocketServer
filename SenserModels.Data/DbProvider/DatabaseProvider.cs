...
namespace SenserModels.Data
{
	public class DatabaseProvider
	{
		...
		private static void GetProvider()
		{
			try
			{
				_instance = (IDataProvider)Activator.CreateInstance(Type.GetType(string.Format("SenserModels.Data.{0}.DataProvider, SenserModels.Data.{0}", BaseConfigs.GetDbType), false, true));
			}
			catch
			{
