...
namespace SerialPortController
{
    public class CollecterController : SenserController
    {
        ...
        protected override SerialController AddComController(string setting)
        {
            ...
            CollecterComController collecterComController = new CollecterComController(comSettings[0],
            ...
            this.comControllerDictionary.Add(comSettings[0], collecterComController);
        ...
        /// 创建传感器列表
        /// </summary>
        protected override void AddSenser(SerialController collecterComController, string addressList)
        {
            this.pollRun = false;
            ...
            foreach (string address in addresses)
            {
                ...
                DataCollector dataCollector = new DataCollector(byteAddress, (CollecterComController)collecterComController);
