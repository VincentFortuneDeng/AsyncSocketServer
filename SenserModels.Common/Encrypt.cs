...
//		}
    ...
    public class MD5
    {
        public static string ComputeHashSting(string input)
        {
        ...
        public static bool VerifyHashString(string input, string hash)
        {
            // Hash the input.
            //string hashOfInput = ComputeHashSting(input);
